        ...
        var bandarray = [
            {
                ...
                description: 'The Who sample page with a brief description of the rock band and the youtube video: "My generation"',
                keywords: 'rock, who, "My generation"',
                video: 'Lelc4pvmp60'
            },
            {
                id: 2,
                ...
                description: 'The Rolling Stones sample page with a brief description of the rock band and the youtube video: "Angie"',
                keywords: 'rock, Rolling Stones, "Angie"',
                video: 'UYfFrb6ZECY'
            },
            {
                id: 3,
                ...
                description: 'The Beatles sample page with a brief description of the rock band and the youtube video: "With A Little Help From My Friends"',
                keywords: 'rock, Beatles, "With A Little Help From My Friends',
                video: '75Oct1Qv8x0'
            },
            {
                id: 4,
                ...
                description: 'Queen sample page with a brief description of the rock band and the youtube video: "Mustafa Ibrahim"',
                keywords: 'rock, Queen, "Mustafa Ibrahim"',
                video: '5-zh0a6nDTo'
            }
        ];
